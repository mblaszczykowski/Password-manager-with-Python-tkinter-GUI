...
class App():
    def __init__(self):
        ...
        self.welcomeLabel = Label(self.root, text='hello!',fg='black', bg='white', font=("Baskerville", 44))
        ...
        self.registerButton = Button(self.root, highlightbackground='white', text='create account', command=self.showRegistrationPage, bg='yellow', background='yellow', activebackground='white', highlightcolor='white', bd=2)
    ...
    def showRegistrationPage(self):
        ...
        def createaccountdef():
            ...
            if login != "" and password != "":
                if platform == "linux" or platform == "linux2":
                    path = '/home/' + username + '/Documents/password_manager/logins/'

                elif platform == "darwin":
                    path = '/Users/' + username +'/Documents/password_manager/logins/'
                ...
                if platform == "linux" or platform == "linux2":
                    path = '/home/' + username + '/Documents/password_manager/content/accounts/'

                elif platform == "darwin":
                    path = '/Users/' + username +'/Documents/password_manager/content/accounts/'
                ...
                self.welcomeLabel.configure(text='hello!')
                self.showLoginPage()
    ...
    def getLogin(self,_Event=None):
        ...
        if self.login != "":
            ...
            if platform == "linux" or platform == "linux2":
                directory = '/home/' + username + '/Documents/password_manager/logins'

            elif platform == "darwin":
                directory = '/Users/' + username +'/Documents/password_manager/logins'
